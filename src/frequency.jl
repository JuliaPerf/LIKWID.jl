...
set_cpu_clock_max(cpuid::Integer, freq::Integer) = LibLikwid.freq_setCpuClockMax(cpuid, freq)
set_cpu_clock_min(cpuid::Integer, freq::Integer) = LibLikwid.freq_setCpuClockMin(cpuid, freq)
