...
@time begin
    if GROUP == "All" || GROUP == "CPU" || GROUP == "Basics"
        ...
        @time @safetestset "NUMA" begin
            include("numa_test.jl")
        end
        @time @safetestset "Affinity" begin
            include("affinity_test.jl")
        end
        @time @safetestset "Timer" begin
            include("timer_test.jl")
        end
        @time @safetestset "Configuration" begin
    ...
    if GROUP == "All" || GROUP == "CPU" || GROUP == "Pinning"
        @time @safetestset "Pinning" begin
            include("pinning_test.jl")
        end
    end

    if GROUP == "All" || GROUP == "CPU" || GROUP == "Daemon"
        # requires LIKWID access daemon
        @time @safetestset "Thermal" begin
            include("thermal_test.jl")
        end
        @time @safetestset "Power" begin
            include("power_test.jl")
        end
        @time @safetestset "Access" begin
            include("access_test.jl")
        end
    end

    # CLI
    if GROUP == "All" || GROUP == "CPU" || GROUP == "CLI"
        @time @safetestset "Marker API CPU (CLI)" begin
            include("marker_cpu_cli/marker_cpu_cli_test.jl")
        end
        @time @safetestset "Marker File Reader (CLI)" begin
            include("markerfile/markerfile_cli_test.jl")
        end
    ...
    if GROUP == "All" || GROUP == "GPU"
        @time @safetestset "Topology (GPU)" begin
            include("gpu/topology_gpu_test.jl")
        end
        @time @safetestset "NvMon (GPU)" begin
            include("gpu/nvmon_test.jl")
        end
        @time @safetestset "Marker API GPU (CLI)" begin
            include("gpu/marker_gpu_cli/marker_gpu_cli_test.jl")
        end
    end
end
